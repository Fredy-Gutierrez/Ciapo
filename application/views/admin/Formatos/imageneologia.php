            ...
            <div class="box-body">
                <div class="row">
                    <div class="table-responsive col-md-12">
                        ...
                        <form action="<?php echo base_url();?>mantenimiento/Formatos/storeimage" method="POST">
                              ...
                              <thead >
                                ...
                                <div class="row">
                                  <div class="col-md-12">
                                    ...
                                    <div  class="form-group" align="center"> 
                                        <label for="antecedentes">Diagnostico y Resumen:</label>
                                        <textarea class="form-control" style="resize:none;" id="diagnostico" name="diagnostico" ></textarea>
                                    </div>
