            ...
            <div class="box-body">
                <div class="row">
                    <div class="table-responsive col-md-12">
                        ...
                        <form action="<?php echo base_url();?>mantenimiento/Formatos/storehosp" method="POST">
                                ...
                                <div class="row">
                                  <div class="col-md-12">
                                    ...
                                    <div  class="form-group" align="center"> 
                                        ...
                                        <textarea class="form-control" cols="40" rows="5" style="resize:none;" id="medicamentos" name="medicamentos" required></textarea>
                                    </div>
