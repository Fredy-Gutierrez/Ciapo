            ...
            <div class="box-body">
                <div class="row">
                    <div class="table-responsive col-md-12">
                        ...
                        <form action="<?php echo base_url();?>mantenimiento/Formatos/storeanatomia" method="POST">
                          ...
                          <table class="table table-striped">
                                <thead>
                                    ...
                                    <div class="form-group">
                                    <label for="ced"><br/>FECHA DE ENVIO:</label>
                                    <input type="date"    id="fecha" name="fecha" required>
                                    </div>
                                    <br/>
                                    <div class="form-group">
                                    <label for="ced">TIPO DE ESTUDIO SOLICITADO:</label>
                                    ...
                                    <select name="estudio">
                                      ...
                                      <option value="REV. LAMINILLAS">REV. LAMINILLAS</option>
                                      <option value="INMUNOHISTOQUIMICA">INMUNOHISTOQUIMICA</option>
                                    </select>
                                    </div>
                                    <br/>
                                    <div class="form-group">
                                      <label for="ced">SERVICIO:</label>
                                      <input type="nummber"    id="servicio" name="servicio"  required>
                                    </div>
                                    <br/>
                                    <div class="form-group">
                                      <label for="ced">CAMA:</label>
                                      <input type="nummber"    id="cama" name="cama"  required>
                                    </div>
                                    <br/>
                                    <div class="form-group">
                                      <label for="ced">NUMERO DE ESTUDIO:</label>
                                      <input type="nummber"    id="num" name="num"  required>
                                    </div>
                          ...
                          <table class="table table-striped">
                              <thead >
                                ...
                                <div class="row">
                                  <div class="col-md-12">
                                    ...
                                    <div  class="form-group" align="center"> 
                                        <label for="antecedentes">TIPO DE PIEZA QUIRURGICA O ESPECIMEN ENVIADO:</label>
                                        <textarea class="form-control" style="resize:none;" id="pieza" name="pieza" ></textarea>
                                    </div>
                              ...
                              <div class="row">
                                  <div class="col-md-12">
                                    ...
                                    <div  class="form-group" align="center"> 
                                        <label for="antecedentes">DATOS CLINICOS:</label>
                                        <textarea class="form-control" style="resize:none;" id="datos" name="datos" ></textarea>
                                    </div>
