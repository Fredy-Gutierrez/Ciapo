            ...
            <div class="box-body">
                <div class="row">
                    <div class="table-responsive col-md-12">
                        ...
                        <form action="<?php echo base_url();?>mantenimiento/Formatos/storeinter" method="POST">
                          ...
                          <table class="table table-striped">
                                <thead>
                                    ...
                                    <div class="form-group">
                                    <label for="ced">Servicio solicitado:</label>
                                    <input type="nummber"    id="cita" name="cita"  class="form-control" >
                                    </div>
                                  </th>
                              ...
                              <thead >
                                ...
                                <div class="row">
                                  <div class="col-md-12">
                                    ...
                                    <div  class="form-group" align="center"> 
                                        <label for="antecedentes">Motivo de consulta:</label>
                                        <textarea class="form-control" style="resize:none;" id="motivo" name="motivo" ></textarea>
                                    </div>
                                ...
                                <div class="row">
                                  <div class="col-md-12">
                                    ...
                                    <div  class="form-group" align="center"> 
                                        <label for="antecedentes">Resumen clinico:</label>
                                        <textarea class="form-control" style="resize:none;" id="resumen" name="resumen" ></textarea>
                                    </div>
