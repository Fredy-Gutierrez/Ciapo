		...
		<table border=2 width="100%" cellspacing=0 cellpadding=1 class="table">
			...
			<tr id="tr">
				...
				<td id="td" colspan="4">
					...
					DIRECCIÓN GENERAL DE GESTIÓN DE SERVICIOS DE SALUD <br/> DIRECCIÓN DE ADMINISTRACIÓN DE PLANES <br/><span style='font-size:5.6;font-family:"Corbel",sans-serif;'> FONDO DE PROTECCIÓN CONTRA GASTOS CATASTRÓFICOS<br/> <span style='font-size:5.4;font-family:"Corbel",sans-serif;'>FORMATO DE AUTORIZACIÓN PARA PAGO DE PERTUZUMAB</center></span></label> 
				</td>
				<td id="td" width="16.6%">
			...
			<tr>
				<td id="td2" align="right" width="20%">
					<label id="p">Paciente con edad = o >18 años </label>
				</td>
			...
			<tr>
				<td id="td2" align="right">
					<label id="p">Paciente con menopausia </label>
				</td>
				<td id="td2" align="left" colspan="5">
						<label id="p">SI</label> <label id="p3"> 
						<?php if($meno==1){
			...
			<tr>
				<td id="td2" align="right">
					<label id="p">Tumor mayor a 2 cm* </label>
				</td>
				<td id="td2" align="left" colspan="5">
						<label id="p">SI</label> <label id="p3"> 
						<?php if($tumor==1){
			...
			<tr>
				<td id="td2" align="right">
					<label id="p">Insuficiencia Renal </label>
				</td>
				<td id="td2" align="left" colspan="5">
						<label id="p">SI</label> <label id="p3"> 
						<?php if($renal==1){
			...
			<tr>
				<td id="td2" align="right">
					<label id="p">Recurrencia o Etapa IV* </label>
				</td>
				<td id="td2" align="left" colspan="5">
						<label id="p">SI</label> <label id="p3"> 
						<?php if($etapa==1){
			...
			<tr>
				<td id="td2" align="right">
					<label id="p">Receptores estrogénicos postivos </label>
				</td>
				<td id="td2" align="left" colspan="5">
						<label id="p">SI</label> <label id="p3"> 
						<?php if($recep==1){
			...
			<tr>
				<td id="td2" align="right">
					<label id="p3"> <?php if($monoterapia==1){
						    			echo "&nbsp;"."X"." ";
						    		}else
						    		{
						    			echo "&nbsp;&nbsp;&nbsp;";
				...
				<td id="td2" align="left">
					<label id="p">Monoterapia </label>
				</td>
				<td id="td2" align="right">
					<label id="p3"> <?php if($taxano==1){
						    			echo "&nbsp;"."X"." ";
						    		}else
						    		{
						    			echo "&nbsp;&nbsp;&nbsp;";
				...
				<td id="td2" align="left" colspan="3">
					<label id="p">Con un taxano </label>
				</td>
			</tr>	
			<tr>
				<td id="td2" align="right">
					<label id="p3"> <?php if($platinos==1){
						    			echo "&nbsp;"."X"." ";
						    		}else
						    		{
						    			echo "&nbsp;&nbsp;&nbsp;";
				...
				<td id="td2" align="left">
					<label id="p">Con taxano y platinos</label>
				</td>
				<td id="td2" align="right">
					<label id="p3"> <?php if($trata==1){
						    			echo "&nbsp;"."X"." ";
						    		}else
						    		{
						    			echo "&nbsp;&nbsp;&nbsp;";
				...
				<td id="td2" align="left" colspan="3">
					<label id="p">Tratamiento por recaída de cáncer metastásico con quimiterapia previa</label>
				</td>
				
			</tr>
			<tr>
				<td id="td2" align="right">
					<label id="p3"> <?php if($combinacion==1){
						    			echo "&nbsp;"."X"." ";
						    		}else
						    		{
						    			echo "&nbsp;&nbsp;&nbsp;";
				...
				<td id="td2" align="left">
					<label id="p">Combinación</label>
				</td>
				<td id="td2" align="right">
					<label id="p3"> <?php if($aroma==1){
						    			echo "&nbsp;"."X"." ";
						    		}else
						    		{
						    			echo "&nbsp;&nbsp;&nbsp;";
				...
				<td id="td2" align="left" colspan="3">
					<label id="p">Con inhibidor de aromatasa</label>
				</td>
				
			</tr>	
			<tr>
				<td id="td2" align="right">
					<label id="p3"> <?php if($ciclo==1){
						    			echo "&nbsp;"."X"." ";
						    		}else
						    		{
						    			echo "&nbsp;&nbsp;&nbsp;";
				...
				<td id="td2" align="left">
					<label id="p">Con antraciclina, ciclofosfamida y taxano</label>
				</td>
				<td id="td2" align="right">
					<label id="p3"> <?php if($anticuerpo==1){
						    			echo "&nbsp;"."X"." ";
						    		}else
						    		{
						    			echo "&nbsp;&nbsp;&nbsp;";
				...
				<td id="td2" align="left" colspan="3">
					<label id="p">Con otro anticuerpo monoclonal (trastuzumab)</label>
				</td>
			...
			<tr>
				<td id="td2" align="right">
					<label id="p">Acepto tratamiento con Pertuzumab</label>
				</td>
			...
			<tr>
				<td id="td2" align="right">
					<label id="p">Confirma administración de Pertuzumab</label>
				</td>
				<td id="td2" align="left" colspan="2">
					<label id="p3">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
				</td>
