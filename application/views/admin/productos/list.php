                ...
                <div class="row">
                    <div class="col-md-12">
                        <table id="example1" class="table table-bordered table-hover">
                            <thead>
                                <tr>
                                    <!--<th>#</th>--> <!-- Se crean las columnas que se mostraran-->
                                    <th>Codigo</th>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    ...
                                                    <a href="<?php echo base_url()?>mantenimiento/productos/edit/<?php echo $producto->id_prod;?>" class="btn btn-warning"><span class="fa fa-pencil"></span></a> <!-- Para editar-->
                                                    <a href="<?php echo base_url();?>mantenimiento/productos/delete/<?php echo $producto->id_prod;?>" class="btn btn-danger btn-remove"><span class="fa fa-remove"></span></a>
                                                </div>
                                            </td>
                                        </tr>
                                    <?php endforeach;?>
