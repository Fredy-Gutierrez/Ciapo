                                ...
                                <?php if(!empty($categorias2)):?>
                                    <?php foreach($categorias2 as $categoria):?>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    <a href="<?php echo base_url();?>mantenimiento/categorias2/activar/<?php echo $categoria->id_cat;?>" class="btn btn-warning"><span class="fa fa-refresh"></span></a>
                                                </div>
                                            </td>
                                        </tr>
                                    <?php endforeach;?>
