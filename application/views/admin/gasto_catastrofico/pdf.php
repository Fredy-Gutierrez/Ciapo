        ...
        <table class="table" border="0.5px" cellspacing=2 cellpadding=2>
            <thead>
                <tr>
                    ...
                    <th style="width:4%; background-color: #3B3B3B;"><center><font lang=ES style='font-size:9.0;font-family:"Arial"' color="white">VALIDADO O NO VALIDADO</font></center></th>
                </tr>
            </thead>
                    ...
                    <?php foreach ($medicinas as $medicinas): ?>
                        <tr>
                            ...
                            <?php if ($medicinas->validacion=="t"): ?>
                                <td style="width:3%"><center><span lang=ES style='font-size:9.0;font-family:"Arial"'>VALIDADO</span></center></td> 
                            <?php endif ?>

                            <?php if ($medicinas->validacion=="f"): ?>
                               <td style="width:3%"><center><span lang=ES style='font-size:9.0;font-family:"Arial"'>NO VALIDADO</span></center></td>
                            <?php endif ?>
                ...
                <tbody>
                    ...
                    <?php foreach ($medAlt as $medAlt): ?>
                        <tr>
                            ...
                            <?php if ($medAlt->validacion=="t"): ?>
                                <td style="width:3%"><center><span lang=ES style='font-size:9.0;font-family:"Arial"'>VALIDADO</span></center></td> 
                            <?php endif ?>

                            <?php if ($medAlt->validacion=="f"): ?>
                               <td style="width:3%"><center><span lang=ES style='font-size:9.0;font-family:"Arial"'>NO VALIDADO</span></center></td>
                            <?php endif ?>
                        </tr>
                    <?php endforeach ?>
...
<!--
    ...
    <style>
        ...
        <div style="overflow-x:auto;">
            <?php if (!empty($medicinas2) or !empty($medAlt2)): ?>
                
            <?php endif ?>
            <table cellspacing=1 cellpadding=1 class="table">
                <tr>
                    <th><font style='font-size:9.0;font-family:"Arial"'>OBSERVACIONES POR EL AREA DE FPGC</font></th>
                </tr>
            </table>
            ...
            <table  class="table">
                <tr>
                    <th >
                        <tr>
                            <th style="background-color: #3B3B3B;"><font color="white" style='font-size:9.0;font-family:"Arial"'>MEDICAMENTO ONCOLÓGICO RECHAZADO</font></th>
                            <th style="background-color: #3B3B3B;"><font color="white" style='font-size:9.0;font-family:"Arial"'>OBSERVACIÓN</font></th>
                        </tr>
                        <?php if(!empty($medicinas2)):?>
                            <?php if (!empty($medjus->count)): ?>

                                <?php foreach($medicinas2 as $medicinas2):?>
                                
                                    <?php if(!empty($medicinas2->justif)):?>
                                       
                                        
                                        <tr>
                                            <td style="width:50%;"><font style='font-size:9.0;font-family:"Arial"'><?php echo $medicinas2->nombregen;?></font></td>
                                            <td ><font style='font-size:9.0;font-family:"Arial"'><?php echo $medicinas2->justif;?></font></td>
                                        </tr>
                            ...
                            <?php else: ?>
                                <tr>
                                    <td colspan="2"><center>No hay Observaciones para Medicamentos Oncológicos</center></td>
                                </tr>
                            <?php endif ?>
            ...
            <table  class="table">
                <tr>
                    <th >
                        <tr>
                            <th style="background-color: #3B3B3B;"><font color="white" style='font-size:9.0;font-family:"Arial"'>MEDICAMENTO ALTERNATIVO RECHAZADO</font></th>
                            <th style="background-color: #3B3B3B;"><font color="white" style='font-size:9.0;font-family:"Arial"'>OBSERVACIÓN</font></th>
                        </tr>
                        <?php if(!empty($medAlt2)):?>
                            <?php if (!empty($medAltJust->count)): ?>
                                <?php foreach($medAlt2 as $medAlt2):?>
                                    <?php if(!empty($medAlt2->justif)):?>
                                        
                                        <tr>
                                            <td><font style='font-size:9.0;font-family:"Arial"'><?php echo $medAlt2->medicamento;?></font></td>
                                            <td style="width:50%;"><font style='font-size:9.0;font-family:"Arial"'><?php echo $medAlt2->justif;?></font></td>
                                        </tr>
                            ...
                            <?php else: ?>
                                <tr>
                                    <td colspan="2"><center>No hay Observaciones para Medicamentos Alternativos</center></td>
                                </tr>
                            <?php endif ?>
        ...
        <table cellspacing=1 cellpadding=1 class="table" >
            ...
            <tr align = left>
                <th align = left>Medico Especialista</th>
                <th><?php echo $medico->nombre." ".$medico->ape_pat." ".$medico->ape_mat;?></th>
                <tr align = left>
                    <th align = left>Especialidad</th>
                    <th><?php echo $medico2->nombreesp;?></th>
                </tr>

                <tr align = left>
                    <th align = left>Cedula de Especialidad</th>
                    <th>
                        <?php echo $medico2->cedula;?>
                    </th>
