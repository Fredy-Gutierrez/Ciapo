            ...
            <div class="box-body">
                <div class="row">
                    <div class="table-responsive col-md-12">
                        ...
                        <form action="<?php echo base_url();?>mantenimiento/notamedica/consecuente" method="POST">
                            
                            <div class="box-body">
                                <div class="row">
                                      <div class="col-md-12">
                                        <div  class="form-group"> 
                                            <label for="expediente">NO. DE EXP</label>
                                            <input type="nummber" style=" width:150px;height:30px" id="no_exp" name="no_exp" value="" required>
                                            <button type="submit" style=" width:80px;height:30px" class="btn btn-success btn-flat">BUSCAR</button>
                                        </div>
                                      </div>
                                </div>
                            </div>
                                ...
                                <table class='table table-bordered table-hover' id="tablaEstudios">
                                  ...
                                  <?php if(!empty($estudios)):?>
                                    ...
                                    for ($i=0; $i < sizeof($estudios); $i++) {
                                      ...
                                      if ($i >= $x) { ?>
                                            <tr>
                                              <td><?php echo $estudios[$i]->descripcion;?></td>
                                ...
                                <div class="row">
                                  <div class="col-md-4">
                                    <div  class="form-group" align="right">
                                        ...
                                        <button type="submit" class="btn btn-success" onclick=this.form.action="<?php echo base_url();?>mantenimiento/notamedica/onlystoreconsecuente">
                                  ...
                                  <div class="col-md-4">
                                    <div  class="form-group" align="center">
                                        <button type="submit" class="btn btn-success" onclick=this.form.action="<?php echo base_url();?>mantenimiento/notamedica/storeandprintconsecuente">
                                  ...
                                  <div class="col-md-4">  
                                    <div  class="form-group" align="left">
                                        <button type="submit" class="btn btn-success" onclick=this.form.action="<?php echo base_url();?>mantenimiento/notamedica/updateConsecuente">
